    ...
    <div class="columns">
      <div class="column is-12">
        <h4 class="page-header">
          ...
          <span>Статистика аккаунта "{{ room.name }}"</span>
        </h4>
      </div>
    </div>
    <div class="columns">
        ...
        <nav class="level" style="width: 100%">
          <div class="level-item has-text-centered">
            <div>
              ...
              <p class="title m3">
                {{ new Intl.NumberFormat().format(room.bets_count) }}
              </p>
            </div>
          </div>
          <div class="level-item has-text-centered">
            <div>
              ...
              <p class="title m3">
                <Money currency="EUR" v-bind:amount="room.turnover"/>
              </p>
            </div>
          </div>
          <div class="level-item has-text-centered">
            <div>
              ...
              <p class="title m3">
                <Money currency="EUR" v-bind:amount="room.profit"/>
              </p>
            </div>
          </div>
          <div class="level-item has-text-centered">
